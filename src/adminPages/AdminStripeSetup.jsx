...
export default function AdminStripeConnectSetup() {
  ...
  const generateConnectId = async () => {
    ...
    const mockConnectId = `acct_${Math.random().toString(36).substr(2, 16)}`
    setConnectId(mockConnectId)
    setCompletedSteps([1])
    setLoadingSteps([])
  }
            ...
            <div className="flex-shrink-0">
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${
                  isStepCompleted(1) ? "bg-green-500 text-white" : "bg-gray-300 text-gray-700"
                }`}
              >
                {isStepCompleted(1) ? (
              ...
              <div className="flex items-center space-x-3">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-sm font-medium transition-colors flex-shrink-0 ${
                    isStepCompleted(1) || isStepLoading(1)
            ...
            <div className="flex-1 space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-sm font-medium transition-colors flex-shrink-0 ${
                    !isStepCompleted(1) || isStepCompleted(2) || isStepLoading(2)
                      ? "bg-gray-300 text-gray-500 cursor-not-allowed"
                      : "bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                  }`}
                >
            ...
            <div className="flex-1 space-y-3">
              ...
              <div className="flex items-center space-x-3">
                <button
                  ...
                  className={`px-4 py-2 rounded-md text-sm font-medium transition-colors flex-shrink-0 ${
                    !isStepCompleted(2) || isStepCompleted(3) || isStepLoading(3)
                      ? "bg-gray-300 text-gray-500 cursor-not-allowed"
                      : "bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                  }`}
                >
