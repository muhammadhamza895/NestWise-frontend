...
const Hero = () => {
  ...
  const handleSubmit = (location = searchQuery) => {
    if (location.trim()) {
      navigate(`/user/properties?location=${encodeURIComponent(location)}&type=${propertyType}`);
    }
  };
        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto w-full">
            ...
            >
              ...
              >
                <div className="w-fit mx-auto backdrop-blur-md rounded-3xl shadow-2xl border">
