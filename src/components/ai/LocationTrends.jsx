    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div className="flex items-center">
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-gray-800">Trends In Top Societies Of {locations[0]?.city_name}</h2>
        </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    <div>
                      ...
                      <span className="font-medium">
                        {location.price_per_sqft ? `Rs${location.price_per_sqft.toLocaleString()}` : 'N/A'}
                      </span>
                    </div>
                    <div>
              ...
              <table className="min-w-full bg-white">
                <thead>
                  <tr className="bg-gray-50 border-b">
                    ...
                    <th className="py-3 px-4 text-left font-medium text-gray-700 rounded-tr-lg">Search Percentage (%)</th>
                  </tr>
                </thead>
                  ...
                  {processedLocations.map((location, index) => (
                    ...
                    >
                      ...
                      <td className="py-3 px-4">
                        {location?.city_name ? location.city_name : 'N/A'}
                      </td>
                      {/* <td className="py-3 px-4">
                        <div className="flex items-center">
                          {location.percent_increase != null ? (
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center">
                          {location.search_percentage != null ? (
                            <>
                              {location?.search_percentage}%
                              <div className="ml-2 w-36 h-2 bg-gray-200 rounded-full overflow-hidden">
                                <div 
                                  className="h-full bg-blue-600 rounded-full"
                                  style={{ width: `${Math.min(100, location.search_percentage)}%` }}
                                ></div>
                              </div>
                            </>
                          ) : (
