import { Home, Filter, Building } from "lucide-react";
import { motion } from "framer-motion";

const propertyTypes = ['House', 'Apartment', 'Office', 'Shop', 'Residential Plot', 'Commerical Plot'];
const availabilityTypes = ["Rent", "Buy"];
const priceRanges = [
  { min: 0, max: 5000000, label: "Under Rs50L" },
  { min: 5000000, max: 10000000, label: "Rs50L - Rs1Cr" },
  { min: 10000000, max: 20000000, label: "Rs1Cr - Rs2Cr" },
  { min: 20000000, max: Number.MAX_SAFE_INTEGER, label: "Above Rs2Cr" }
];
  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div className="filter-group">
          <label className="filter-label">
            <span className="w-5 h-5 text-blue-600">Rs</span>
            Price Range
          </label>
          <div className="grid grid-cols-2 gap-2">
