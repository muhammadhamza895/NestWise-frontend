        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <motion.div
              ...
              className="relative rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 shadow-lg group-hover:shadow-blue-500/30"
            >
              <img src={logo} alt="NestWise logo" className="w-12 h-12 brightness-0 invert" />
              {/* Floating sparkles */}
              <motion.div
                  ...
                  <div className="relative" ref={dropdownRef}>
                    ...
                    >
                      ...
                      <div className="hidden lg:flex flex-col items-start">
                        ...
                        <span className="text-xs text-gray-500">{isAdmin ? 'Seller Account' : 'Buyer Account'}</span>
                      </div>
                      <motion.div
...
const NavLinks = ({ currentPath }) => {
  ...
  const isAIHubActive = currentPath.startsWith("/user/ai-property-hub");
  ...
  return (
    <div className="flex space-x-2 items-center">
      ...
      >
        <Link
          to="/user/ai-property-hub"
          className={`relative group font-semibold transition-all duration-300 flex items-center gap-2.5 px-5 py-2.5 rounded-xl overflow-hidden ${isAIHubActive
    ...
    >
      ...
      >
        <Link
          ...
          className={`relative flex items-center gap-4 px-5 py-4 rounded-2xl shadow-lg transition-all duration-300 overflow-hidden ${isAIHubActive
              ...
              <div className="flex items-center space-x-4 relative z-10">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-xs text-yellow-600 font-semibold">{isAdmin ? 'Seller Account' : 'Buyer Account'}</span>
                  </div>
                </div>
              </div>
