  ...
  return (
    ...
    >
      ...
      {/* <p className="mt-4 text-xs text-gray-500 flex items-center gap-1">
        ...
        By subscribing, you agree to our <a className="underline hover:text-blue-600 transition-colors">Privacy Policy</a>.
      </p> */}
    </motion.div>
  );
};
...
const companyLinks = [
  ...
  { name: 'Properties', href: '/user/properties', icon: MapPin },
  { name: 'About Us', href: '/user/about', icon: Star },
  { name: 'Contact', href: '/user/contact', icon: Mail },
  { name: 'AI Property Hub', href: '/user/ai-property-hub', icon: Zap },
];
      ...
      <div className="relative pt-16 lg:pt-20 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Your trusted partner in finding the perfect property. We make property hunting simple, efficient, and tailored to your unique needs with cutting-edge technology and personalized service.
            </motion.p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <motion.p 
              ...
              transition={{ duration: 0.5 }}
            >
              <span>© {new Date().getFullYear()} NestWise. All Rights Reserved.</span>
